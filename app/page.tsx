...
const [replyMode, setReplyMode] = useState("flirty");
...
<div style={{
  ...
  <button
    onClick={() => window.location.href = "/reply"}
    style={{
...
onClick={() => {
  localStorage.setItem("reply_chat", chatText);
...
{/* 🔥 REPLY DEMO (MATCHES HOW IT WORKS STYLE) */}
<section className="featureSection">
  ...
  <div className="featureGrid">
    ...
    <div className="featureCard large">
      ...
      <h3>Generate perfect replies instantly</h3>

      <p>
        Turn any message into confident, funny or flirty replies.
      </p>

      {/* IMAGE */}
      <div className="imageWrapper">
        <img src="/demo-reply-1.png" alt="Reply demo" />
      </div>
    ...
    <div className="featureCard">
      ...
      <p>
        Switch between flirty, funny, confident & more.
      </p>

      <div className="imageWrapper">
        <img src="/demo-reply-2.png" alt="Tone selection" />
      </div>
    ...
    <div className="featureCard">
      ...
      <p>
        Paste your chat and get replies in seconds.
      </p>

      <div className="imageWrapper">
        <img src="/demo-reply-3.png" alt="Instant replies" />
      </div>
